...
type Statement = MustStatement | JustStatement | ReturnStatement | AssignmentStatement
...
interface Id<Ctx extends Context, Id extends keyof Ctx> extends ASTNode<Ctx[Id]>{
  type: 'id'
  ASTNode: string
}
...
type ConverionKindExpr<N extends string, F extends ASTNode<any>, T extends ASTNode<any>> =  T&{
    type: N
    from: F
}
type UnionToIntExpr = ConverionKindExpr<'union-to-int', UnionNode, IntNode>
type IntToBooleanExpr = ConverionKindExpr<'int-to-boolean', IntNode, BooleanNode>
